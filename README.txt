...
1. Upload `rssnewsticker.php` to the `/wp-content/plugins/` directory
...
= 1.2 =
* Reduce text area for ticker text to 25 rows.

= 1.2 =
* Change from text fields to a text area for rss entries.

= 1.0 =
* Initial deployed version.
* Uses text fields to input headlines for rss feed.
